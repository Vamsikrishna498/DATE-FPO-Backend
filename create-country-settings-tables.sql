-- Create hierarchical country settings tables
...
CREATE TABLE IF NOT EXISTS districts (
    ...
    UNIQUE KEY unique_district_per_state (name, state_id)
);
...
CREATE TABLE IF NOT EXISTS villages (
    ...
    UNIQUE KEY unique_village_per_block (name, block_id)
);
...
CREATE TABLE IF NOT EXISTS zipcodes (
    ...
    UNIQUE KEY unique_zipcode_per_village (code, village_id)
);
...
CREATE INDEX idx_zipcodes_village_id ON zipcodes(village_id);
CREATE INDEX idx_zipcodes_code ON zipcodes(code);
