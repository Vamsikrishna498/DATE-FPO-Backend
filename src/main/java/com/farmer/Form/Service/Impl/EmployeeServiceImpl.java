...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public Employee updateEmployeeBySuperAdmin(Long id, Employee updated) {
        Employee existing = getEmployeeRawById(id);
    ...
    public void deleteEmployeeBySuperAdmin(Long id) {
        // First, unassign all farmers from this employee to avoid foreign key constraint violations
        List<Farmer> assignedFarmers = farmerRepository.findByAssignedEmployee_Id(id);
        if (!assignedFarmers.isEmpty()) {
            for (Farmer farmer : assignedFarmers) {
                farmer.setAssignedEmployee(null);
